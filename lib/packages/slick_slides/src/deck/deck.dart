...
import 'package:slide_maker/packages/slick_slides/src/deck/slide_config.dart';
...
class SlideDeckState extends State<SlideDeck> {
  ...
  _SlideIndex _slideIndex = const _SlideIndex(1, 1);
  ...
  void _onChangeSlide(_SlideIndex newIndex, _SlideArguments arguments) {
    if (_index != newIndex) {
      ...
      setState(() {
        _index = newIndex;
        _slideIndex = _SlideIndex(_index.index + 1, _index.subIndex + 1);
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: Color.fromARGB(255, 13, 127, 161),
