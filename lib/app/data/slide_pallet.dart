...
class SlidePallet {
  ...
  PalletCatagory palletCatagory = PalletCatagory.Abstract;
  ...
  SlidePallet({
    ...
    this.palletCatagory = PalletCatagory.Abstract,
  });
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'slideTitlesTextProperties': jsonEncode(
          slideTitlesTextProperties?.map((e) => e.toMap()).toList() ?? []),
      'slideSectionHeadersTextProperties': jsonEncode(
          slideSectionHeadersTextProperties
                  ?.map((e) => e.map((element) => element.toMap()).toList())
                  .toList() ??
              []),
      'slideSectionContentsTextProperties': jsonEncode(
  ...
  static SlidePallet fromMap(Map<String, dynamic> map) {
    print(
        "slideTitlesTextProperties (raw from DB): ${map['slideTitlesTextProperties']}");
    print(
        "slideSectionHeadersTextProperties (raw from DB): ${map['slideSectionHeadersTextProperties']}");
    print(
        "slideSectionContentsTextProperties (raw from DB): ${map['slideSectionContentsTextProperties']}");
    return SlidePallet(
      ...
      slideTitlesTextProperties: (map['slideTitlesTextProperties'] != null &&
              (jsonDecode(map['slideTitlesTextProperties']) as List).isNotEmpty)
          ? List<TextProperties>.from(
              (jsonDecode(map['slideTitlesTextProperties']) as List)
                  .map((e) => TextProperties.fromMap(e)))
          : [],
      slideSectionHeadersTextProperties:
          (map['slideSectionHeadersTextProperties'] != null &&
                  (jsonDecode(map['slideSectionHeadersTextProperties']) as List)
                      .isNotEmpty)
              ? (jsonDecode(map['slideSectionHeadersTextProperties']) as List)
                  .map((header) => List<TextProperties>.from(
                      (header as List).map((e) => TextProperties.fromMap(e))))
                  .toList()
              : [],
      slideSectionContentsTextProperties:
          (map['slideSectionContentsTextProperties'] != null &&
                  (jsonDecode(map['slideSectionContentsTextProperties'])
                          as List)
                      .isNotEmpty)
              ? (jsonDecode(map['slideSectionContentsTextProperties']) as List)
                  .map((content) => List<TextProperties>.from(
                      (content as List).map((e) => TextProperties.fromMap(e))))
                  .toList()
              : [],
    );
  }
