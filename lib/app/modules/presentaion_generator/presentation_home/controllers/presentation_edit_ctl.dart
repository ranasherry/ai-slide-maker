...
class PresentationEditCtl extends GetxController {
  ...
  void initializeSlidesTextController() {
    ...
    slideTitles = myEditedPresentation.value.slides.map((slides) {
...
// Example: slideSectionHeaders[1][1] accesses the TextEditingController
    slideSectionHeaders = myEditedPresentation.value.slides.map((slides) {
...
// Example: slideSectionContents[1][1] accesses the TextEditingController
    slideSectionContents = myEditedPresentation.value.slides.map((slides) {
      return slides.slideSections.map((slideSection) {
  ...
  void setFontValue(
      int firstIndexOfFont,
      int secondIndexOfFont,
      bool isSectionHeader,
      bool isSectionContent,
      bool isTitle,
      double setValue) {
    if (isTitle) {
      ...
      slideSectionContentsFontValue
          .value[firstIndexOfFont][secondIndexOfFont].value = setValue;
      developer.log(
          "Editing SectionContent ${firstIndexOfFont} ${secondIndexOfFont}");
      developer.log(
          "set Value ${slideSectionContentsFontValue.value[firstIndexOfFont][secondIndexOfFont].value}");
    } else if (isSectionHeader) {
      slideSectionHeadersFontValue
          .value[firstIndexOfFont][secondIndexOfFont].value = setValue;
      developer.log(
          "Editing SectionHeader ${firstIndexOfFont} ${secondIndexOfFont}");
      developer.log(
          "set Value ${slideSectionHeadersFontValue.value[firstIndexOfFont][secondIndexOfFont].value}");
    } else {}
  }
