...
class PresentationEditIndividualSlideView extends GetView<PresentationEditCtl> {
  ...
  double bottomNavbarHeight = SizeConfig.blockSizeVertical * 10.4;
  @override
        ...
        body:
         WillPopScope(
          onWillPop: () async {
              ...
              if(controller.isBottomNavbarTextEditorVisible.value || controller.isBottomNavbarEditorVisible.value || controller.isBottomNavbarTextFieldVisible.value || controller.isFontSizeProviderVisible.value){
              controller.toggleVisibilityTextEditor(false);
              controller.toggleVisibilityBottomNavbarTextField(false);
