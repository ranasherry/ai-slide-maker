        ...
        children: [
          Container(
              ...
              child: CachedNetworkImage(
                imageUrl:
                    "https://www.figma.com/file/eKPcYkncdTvE7OaqSE1asF/Video-Downloader?type=design&node-id=758-95&mode=design&t=efxn8G1saCQKabv8-0",
                errorWidget: (context, url, error) {
                  return Container(
                      child: Image.asset(AppImages.invitation_template1));
                },
              )),
          Column(
            children: [
