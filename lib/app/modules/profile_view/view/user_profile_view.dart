...
class UserProfileView extends GetView<UserProfileviewController> {
            ...
            : Column(
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: controller.userData.value.profilePicUrl != null
                            ? ClipOval(
                      ...
                      Column(
                        ...
                        children: [
                          Text(controller.userData.value.name ?? "Name",
                          ...
                          verticalSpace(SizeConfig.blockSizeVertical * 0.7),
                          Text(controller.userData.value.email.isEmpty
                              ? "No Email"
                              : controller.userData.value.email),
                          verticalSpace(SizeConfig.blockSizeVertical * 0.7),
                          Row(
                            children: [
                              Text(controller.userData.value.gender.isEmpty
                                  ? "Gender"
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        "${(controller.userData.value.name ?? "User").split(' ').first}'s Creations",
                        style: GoogleFonts.inter(
                            textStyle: TextStyle(
  ...
  Widget followers_method(String text) {
